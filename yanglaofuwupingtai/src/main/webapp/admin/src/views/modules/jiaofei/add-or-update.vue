    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费原因" prop="jiaofeiName">
                       <el-input v-model="ruleForm.jiaofeiName"
                                 placeholder="缴费原因" clearable  :readonly="ro.jiaofeiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="缴费原因" prop="jiaofeiName">
                           <el-input v-model="ruleForm.jiaofeiName"
                                     placeholder="缴费原因" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaofeiName: [
                              { required: true, message: '缴费原因不能为空', trigger: 'blur' },
                          ],
                   jiaofeiTime: [
