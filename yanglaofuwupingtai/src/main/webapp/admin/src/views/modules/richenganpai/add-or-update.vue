    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事情" prop="richenganpaiName">
                       <el-input v-model="ruleForm.richenganpaiName"
                                 placeholder="事情" clearable  :readonly="ro.richenganpaiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="事情" prop="richenganpaiName">
                           <el-input v-model="ruleForm.richenganpaiName"
                                     placeholder="事情" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="时间" prop="richenganpaiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.richenganpaiTime"
                                type="datetime"
                                placeholder="时间"
                                :disabled="ro.richenganpaiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.richenganpaiTime" label="时间" prop="richenganpaiTime">
                            <span v-html="ruleForm.richenganpaiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    richenganpaiName: false,
                    richenganpaiTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    richenganpaiName: '',
                ...
                rules: {
                   ...
                   richenganpaiName: [
                              { required: true, message: '事情不能为空', trigger: 'blur' },
                          ],
                   richenganpaiTime: [
