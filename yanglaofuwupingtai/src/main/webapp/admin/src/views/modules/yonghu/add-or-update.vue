    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老人身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="老人身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="老人身份证号" prop="yonghuIdNumber">
                           <el-input v-model="ruleForm.yonghuIdNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保卡号" prop="yonghuKahao">
                       <el-input v-model="ruleForm.yonghuKahao"
                                 placeholder="医保卡号" clearable  :readonly="ro.yonghuKahao"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="医保卡号" prop="yonghuKahao">
                           <el-input v-model="ruleForm.yonghuKahao"
                                     placeholder="医保卡号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="籍贯" prop="yonghuJiguan">
                       <el-input v-model="ruleForm.yonghuJiguan"
                                 placeholder="籍贯" clearable  :readonly="ro.yonghuJiguan"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="籍贯" prop="yonghuJiguan">
                           <el-input v-model="ruleForm.yonghuJiguan"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="入院日期" prop="yonghuTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuTime" label="入院日期" prop="yonghuTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuIdNumber: [
                              { required: true, message: '老人身份证号不能为空', trigger: 'blur' },
