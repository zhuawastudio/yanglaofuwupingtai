        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yuangongPhoto" label="头像" prop="yuangongPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuangongPhoto" label="头像" prop="yuangongPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="yuangongPhone">
                       <el-input v-model="ruleForm.yuangongPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.yuangongPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="联系方式" prop="yuangongPhone">
                           <el-input v-model="ruleForm.yuangongPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="yuangongEmail">
                       <el-input v-model="ruleForm.yuangongEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.yuangongEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="yuangongEmail">
                           <el-input v-model="ruleForm.yuangongEmail"
