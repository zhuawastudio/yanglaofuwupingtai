    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="来访人名称" prop="laifangdengjiName">
                       <el-input v-model="ruleForm.laifangdengjiName"
                                 placeholder="来访人名称" clearable  :readonly="ro.laifangdengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="来访人名称" prop="laifangdengjiName">
                           <el-input v-model="ruleForm.laifangdengjiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="来访时间" prop="laifangdengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.laifangdengjiTime"
                                type="datetime"
                                placeholder="来访时间"
                                :disabled="ro.laifangdengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.laifangdengjiTime" label="来访时间" prop="laifangdengjiTime">
                            <span v-html="ruleForm.laifangdengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    laifangdengjiName: false,
                    laifangdengjiTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    laifangdengjiName: '',
