<template>
    <div style="backgroundImage: url('/yanglaofuwupingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">养老服务平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="护理姓名" class="input" v-if="tableName=='huli'">
                            <el-input v-model="ruleForm.huliName" autocomplete="off" placeholder="护理姓名"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='huli'">
                            <el-input v-model="ruleForm.huliPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='huli'">
                            <el-input v-model="ruleForm.huliEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
                        ...
                        <el-form-item label="老人身份证号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="老人身份证号"  />
                        </el-form-item>
                        ...
                        <el-form-item label="联系方式" class="input" v-if="tableName=='yuangong'">
                            <el-input v-model="ruleForm.yuangongPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='yuangong'">
                            <el-input v-model="ruleForm.yuangongEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.huliName)&& 'huli'==this.tableName){
                                this.$message.error('护理姓名不能为空');
                                return
                            }
                             if('huli' == this.tableName && this.ruleForm.huliPhone&&(!this.$validate.isMobile(this.ruleForm.huliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('huli' == this.tableName && this.ruleForm.huliEmail&&(!this.$validate.isEmail(this.ruleForm.huliEmail))){
